				...
				<div class="row">
					<div class="col-md-2 my-2">
						<div class="list-group">
                            ...
                            <a href="chulgo.php" class="list-group-item">출고입력</a>
									...
									<div class="row">
									   ...
									   <div class="col-sm-5">
                                          <select name="column" id="column" class="form-control">
												  ...
												  <option value='아워홈' >아워홈</option>
												  <option value='웰스토리' >웰스토리</option>	  
						   ...
						   <div id='rightipgo' class="col-sm-8">
							...
							<table id="table" class="table table-bordered table-hover table-striped" style="border: 1px solid; border-collapse: collapse;">
								...
								<tr style="border: solid 1px;">
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' onkeypress="enter_test('1')" id='row_code1' name='A1' size="35" style="width:100%; height :33px;border:0;"></td>  
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' onkeypress="enter_count('1')" id='row_box1' name='A1' size="10" style="width:100%; height :33px;border:0;">
									<input type='hidden' id='row_ipsu1' name='A1'><input type='hidden' id='row_mappingcode1' name='A1'>
									</td>
									<td style="border: 1px solid; padding:0px;"><input type='text' onkeypress="enter_count('1')" id='row_ea1' name='A1' size="10" style="width:100%; height :33px;border:0;">
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_expire1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
...
function buttonoption(option) { 
 ...
 function save(type){
	...
	var invencol = document.getElementById('column').value;
...
        //alert(jsonData) ;
		...
		xhr.open('POST', 'chulgo_post.php');
		 
		xhr.setRequestHeader("Content-Type", "application/json");
		   
		xhr.send(JSON.stringify({"ipgodate" : ipgodate , "charger" : charger , "invencol" : invencol ,"georae" : georae ,"georaeN" : georaeN ,"warehouse" : warehouse ,"warehouseN" : warehouseN ,"maindata" : ipgoList})); 
 ...
 function excelup() {
  ...
  function add_row() {
	...
	cell2.innerHTML = "<input type='text' onkeypress=enter_test('"+i+"') id='row_code"+i+"' name='"+i+"' size='35' style='width:100%; height :33px;border:0;'>";
