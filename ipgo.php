...
$(document).keydown(function(event) {
  ...
  if (event.keyCode == '40' || event.keyCode == '38' || event.keyCode == '108') {
   ...
   if (itemcode!='' && colindex == "row_code")
   {
	   ...
	   if (data.trim()=='EOF')  // 검색이 둘 이상일 경우에
	   {
		    ...
		    function entereffect(option) {
					 ...
					 var root = 'searchitem.php' + '?item='+geonameinfo+'&num='+option+'&menu=3';
					 var type = '품목검색'
		   ...
		   var temp = fix.replace("code","price");
   ...
   else if(colindex == "row_box" || colindex == "row_ea"  || colindex == "row_surang" )
   { 
	    
		
		//alert(document.getElementById('row_box'+trnumber).value);
	    
		if ((document.getElementById('row_box'+trnumber).value.trim())=="")
		{
			var boxsu = 0;
			document.getElementById('row_box'+trnumber).value = 0;
		}
		else {
		...
		if ((document.getElementById('row_ea'+trnumber).value.trim())=="")
		{
			var ea = 0;
            document.getElementById('row_ea'+trnumber).value = 0;
		}
		else {
			var ea = Number(document.getElementById('row_ea'+trnumber).value);
		}
        
		if ((document.getElementById('row_ipsu'+trnumber).value.trim())=="")
		{
			var ipsu = 0;
            document.getElementById('row_ipsu'+trnumber).value= 0;
		}
		else {
			var ipsu = Number(document.getElementById('row_ipsu'+trnumber).value);
		}
   ...
   else 
   {
	   ...
	   if (event.keyCode == '38' || event.keyCode == '108'){
		   count = trnumber-1;}
	   else{
	   count = trnumber+1;  //포커스 이동을 위해 1을 증가시킴
	   }
				...
				<div class="row">
					<div class="col-md-2 my-2">
						<div class="list-group">
							...
							<a href="ipgo.php" class="list-group-item active">입고입력</a>
						...
						?>
						   ...
						   <div id='rightipgo' class="col-sm-8">
							...
							<table id="table" class="table table-bordered table-hover table-striped" style="border: 1px solid; border-collapse: collapse;">
								...
								<tbody id="my-tbody">
								<tr style="border: solid 1px;">
									<td style="border: 1px solid;"><input type='checkbox' id='chk1' name='addition'/></td> 
									<td style="border: 1px solid; padding:0px;"><input type='text' onkeyup="enter_value('1')" id='row_code1' name='A1' size="35" style="width:100%; height :33px;border:0;"></td>  
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_name1' name='A1' size="120" style="width:100%;height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_rule1' name='A1' size="50" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' onblur="losFocus('1')" onkeypress="enter_count('1')" id='row_box1' name='A1' size="10" style="width:100%; height :33px;border:0;">
									<input type='hidden' id='row_ipsu1' name='A1'><input type='hidden' id='row_mappingcode1' name='A1'>
									</td>
									<td style="border: 1px solid; padding:0px;"><input type='text' onblur="losFocus('1')" onkeypress="enter_count('1')" id='row_ea1' name='A1' size="10" style="width:100%; height :33px;border:0;">
									<td style="border: 1px solid; padding:0px;"><input type='text' onkeypress="enter_count('1')" id='row_surang1' name='A1' size="20" style="width:100%; height :33px;border:0;" readonly></td>
									<td id="row_price00" style="border: 1px solid; padding:0px;"><input type='text' id='row_price1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
								
									<td id="row_supply00" style="border: 1px solid; padding:0px;"><input type='text' id='row_supply1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td id="row_tax00" style="border: 1px solid; padding:0px;"><input type='text' id='row_tax1'  name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_expire1' onkeypress="enter_count3('1')" name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td id="row_hap00" style="border: 1px solid; padding:0px;"><input type='text' id='row_hap1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_etc1' onkeypress="enter_count3('1')" name='A1' size="20" style="width:100%; height :33px;border:0;"></td>	
								</tr>
								</tbody>
							 </table>
...
function buttonoption(option) { 
 ...
 function datamove(nRow){
    ...
    for(var j=nRow ; j  < chkbox.length-1 ; j++)
    {
...
            data.number = i ;
			...
			if(!document.getElementById('row_surang'+i).value) 
	        {
...
        //alert(jsonData) ;
		...
		xhr.send(JSON.stringify({"ipgodate" : ipgodate , "charger" : charger , "georae" : georae ,"georaeN" : georaeN ,"warehouse" : warehouse ,"warehouseN" : warehouseN ,"maindata" : ipgoList})); 
 ...
 function enter_count(numbering){
    ...
    var whatId = $(':focus').attr('id');
    let criteria;
    

	if(whatId.indexOf('row_ea') !== -1) {  
		criteria = (whatId.length>7) ? 2 : 1;
	}
	else{

	    criteria = (whatId.length>8) ? 2 : 1;
    }
	
	let newStr = whatId.substring(0, Number(whatId.length)-criteria);
   ...
   //여기
	...
	var linenumber = Number(numbering)+Number(1); 
	
	var focusmove = newStr+linenumber;
	
	
	document.getElementById('row_surang'+numbering).value = total;
	document.getElementById(focusmove).focus();
	hap();
    } 
 
 }
 function enter_count3(numbering){
	...
	if(whatId.indexOf('row_expire') !== -1) {  

		
		criteria = (whatId.length>11) ? 2 : 1;
	}
	else{
	...
	var focusmove = newStr+(Number(numbering)+1);
	
	document.getElementById(focusmove).focus();
    }
 }
 function enter_count_2(numbering){

    let whatId = $(':focus').attr('id');
	
	let newStr = whatId.substring(0, whatId.length - 1);
...
function enter_value(option){
	   ...
	   if (data.trim()=='EOF')  // 검색이 둘 이상일 경우에
	   {
		   ...
		   else 
		   {
			   ...
			   if (event.keyCode == '38' || event.keyCode == '108'){
				   count = Number(trnumber)-1;
			     
			   }
			   else{
			   count = Number(trnumber)+1;  //포커스 이동을 위해 1을 증가시킴
...
function add_row() {
	...
	cell5.innerHTML = "<input type='text' onblur=losFocus('"+i+"') onkeypress=enter_count('"+i+"') id='row_box"+i+"' name='"+i+"' size='10' style='width:100%; height :33px;border:0;'><input type='hidden' id='row_ipsu"+i+"' name='"+i+"'><input type='hidden' id='row_mappingcode"+i+"' name='"+i+"'>";
	cell6.style.border = '1px solid';
    cell6.style.padding = '0px';

	cell6.innerHTML = "<input type='text' onblur=losFocus('"+i+"') onkeypress=enter_count('"+i+"') id='row_ea"+i+"' name='"+i+"' size='10' style='width:100%; height :33px;border:0;'>";
	...
	cell11.innerHTML = "<input type='text' id='row_expire"+i+"' onkeypress=enter_count3('"+i+"') name='"+i+"' size='20' style='width:100%; height :33px;border:0;'>";
	...
	cell13.innerHTML = "<input type='text' id='row_etc"+i+"' onkeypress=enter_count3('"+i+"') name='"+i+"' size='20' style='width:100%; height :33px;border:0;'>";
