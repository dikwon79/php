						   ...
						   <div id='rightipgo' class="col-sm-8">
							...
							<table id="table" class="table table-bordered table-hover table-striped" style="border: 1px solid; border-collapse: collapse;">
								...
								<tr style="border: solid 1px;">
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_rule1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_surang1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_price1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
								
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_supply1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_tax1'  name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									...
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_hap1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>
									<td style="border: 1px solid; padding:0px;"><input type='text' id='row_etc1' name='A1' size="20" style="width:100%; height :33px;border:0;"></td>	
								</tr>
								</tbody>
							 </table>
							 </div>
							 <div class="hap">
								...
								<button type="button" class="btn btn-success" onclick="buttonoption('add')">추가</button>
								<button type="button" class="btn btn-danger" onclick="buttonoption('del')">삭제</button>
...
function add_row() {
	...
	cell7.innerHTML = "<input type='text' id='row_surang"+i+"' name='"+i+"' size='20' style='width:100%; height :33px;border:0;'>";
