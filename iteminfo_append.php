 <? 
    ...
    if ($using=="all") {
		...
		$where = " where usingY = '$using' and ";
	}

	if($company) $where .= " georae like '%$company%' and ";
	
    if($search) $where .= " (itemcode like '%$search%' or itemname like '%$search%' or mappingcode like '%$search%' or printgubun like '%$search%') and ";
